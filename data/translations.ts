...
export const tr: Dict = {
  ...
  about: {
    ...
    p1: "Lefkoşa doğumlu ve Doğu Akdeniz Üniversitesi öğrencisi olarak, etkili dijital deneyimler yaratma tutkusuyla çalışan kendini adamış bir yazılım geliştiricisiyim. Teknik temelim HTML, CSS, JavaScript, TypeScript, PHP, Laravel ve SQL üzerine kurulu; bu sayede akıcı, işlevsel ve kullanıcı odaklı uygulamalar geliştirebiliyorum.",
